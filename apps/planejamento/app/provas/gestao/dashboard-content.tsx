...
/**
 * DashboardProvasContent Component
 * Client component para o dashboard de gestao de provas
 * Espelha o DashboardContent adaptado para provas
 */
...
export function DashboardProvasContent() {
  const {
    fetchDashboard,
    data,
          ...
          <CardContent className="pt-6">
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-muted-foreground max-w-md">
                Nao foram encontrados dados de provas para exibir no dashboard.
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="grid gap-6 grid-cols-1 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Percentual de provas aprovadas em cada segmento
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Distribuicao das provas no pipeline de aprovacao
            </CardDescription>
          </CardHeader>
          <CardContent>
